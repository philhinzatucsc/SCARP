...
field_size = 1.0            #field size of observations (arcminutes)
...
output_file_name = 'data/PerfvsWavelength-51.txt'
...
num_cores = 3       #set for macbook to avoid running out of memory
